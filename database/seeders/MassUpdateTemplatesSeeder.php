...
class MassUpdateTemplatesSeeder extends Seeder
{
    public function run()
    {
        // Ambil semua template surat kelurahan
        $templates = SuratTemplate::where('type', 'surat_kelurahan')->get();
...
'
        ...
        $this->command->info("Berhasil mengupdate {$templates->count()} template ke format baru.");
    }
}
