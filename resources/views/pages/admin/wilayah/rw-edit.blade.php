...
@section('page-description', 'Perbarui data Rukun Warga.')
...
<div class="max-w-2xl mx-auto bg-white rounded-xl shadow-sm border border-slate-200 p-6">
    <form action="{{ route('admin.wilayah.rw.update', $rw->id) }}" method="POST">
        ...
        <div class="mb-5">
            ...
            <input type="text" name="nomor_rw" id="nomor_rw" class="w-full rounded-lg border-slate-300 focus:ring-blue-500 focus:border-blue-500 @error('nomor_rw') border-red-500 @enderror" placeholder="Contoh: 001" value="{{ old('nomor_rw', $rw->nomor_rw) }}" required>
            @error('nomor_rw')
        ...
        <div class="mb-6">
             <label class="flex items-center gap-2 cursor-pointer">
                <input type="checkbox" name="is_active" value="1" class="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50" {{ $rw->is_active ? 'checked' : '' }}>
