            ...
            <div class="bg-slate-50 p-4 rounded-lg border border-slate-200">
                ...
                <div class="grid grid-cols-1 gap-4">
                    <div>
                        ...
                        <input type="text" name="nomor_rw" class="w-full rounded-md border-2 border-slate-300 bg-white px-3 py-2 text-sm focus:border-blue-500 focus:ring-blue-500 @error('nomor_rw') border-red-500 @enderror" placeholder="Contoh: 001" value="{{ old('nomor_rw', $rw->nomor_rw) }}" required>
            ...
            <div class="bg-slate-50 p-4 rounded-lg border border-slate-200">
                <h3 class="text-sm font-bold text-blue-600 mb-4 pb-2 border-b border-blue-100 flex items-center gap-2">
                 ...
                 <label class="flex items-center gap-2 cursor-pointer">
                    ...
                    <input type="checkbox" name="is_active" value="1" class="h-5 w-5 text-blue-600 border-2 border-slate-300 rounded focus:ring-blue-500" {{ $rw->is_active ? 'checked' : '' }}>
