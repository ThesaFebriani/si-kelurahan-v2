        ...
        <table class="w-full text-left border-collapse">
            <thead>
                <tr class="bg-slate-50 border-b border-slate-200 text-xs uppercase tracking-wider text-slate-500 font-semibold">
                    <th class="pl-4 pr-3 py-3">Nomor RW</th>
                    <th class="px-3 py-3">Jumlah RT</th>
                ...
                <tr class="hover:bg-slate-50/80 transition-colors group">
                    ...
                    <td class="px-3 py-3 text-center w-px whitespace-nowrap">
                        <div class="flex items-center justify-center gap-2">
                            <a href="{{ route('admin.wilayah.rw.edit', $item->id) }}" class="h-8 w-8 flex items-center justify-center rounded-lg bg-blue-50 text-blue-600 hover:bg-blue-100 transition-colors" title="Edit">
