...
@section('page-title', 'Tambah Kartu Keluarga Baru')

@section('content')
<div class="max-w-3xl mx-auto bg-white rounded-lg shadow-sm border border-slate-200 p-6">
    <form action="{{ route('admin.kependudukan.keluarga.store') }}" method="POST">
        @csrf
            ...
            <div class="bg-slate-50 p-4 rounded-lg border border-slate-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="col-span-2">
                        ...
                        <input type="text" name="no_kk" value="{{ old('no_kk') }}" required minlength="16" maxlength="16"
            ...
            <div class="bg-slate-50 p-4 rounded-lg border border-slate-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="kodepos" value="{{ old('kodepos') }}" required maxlength="5"
                            class="w-full rounded-md border-2 border-slate-300 bg-white px-3 py-2 text-sm focus:border-blue-500 focus:ring-blue-500 placeholder-slate-400" placeholder="Contoh: 38119">
                    ...
                    <div>
                        ...
                        <input type="text" name="desa_kelurahan" value="{{ old('desa_kelurahan') }}" required
                            class="w-full rounded-md border-2 border-slate-300 bg-white px-3 py-2 text-sm focus:border-blue-500 focus:ring-blue-500 placeholder-slate-400" placeholder="Contoh: Pagar Dewa">
                    </div>
                    <div>
                        ...
                        <input type="text" name="kecamatan" value="{{ old('kecamatan') }}" required
                            class="w-full rounded-md border-2 border-slate-300 bg-white px-3 py-2 text-sm focus:border-blue-500 focus:ring-blue-500 placeholder-slate-400" placeholder="Contoh: Selebar">
                    </div>
                    <div>
                        ...
                        <input type="text" name="kabupaten_kota" value="{{ old('kabupaten_kota') }}" required
                            class="w-full rounded-md border-2 border-slate-300 bg-white px-3 py-2 text-sm focus:border-blue-500 focus:ring-blue-500 placeholder-slate-400" placeholder="Contoh: Kota Bengkulu">
                    </div>
                    <div>
                        ...
                        <input type="text" name="provinsi" value="{{ old('provinsi') }}" required
                            class="w-full rounded-md border-2 border-slate-300 bg-white px-3 py-2 text-sm focus:border-blue-500 focus:ring-blue-500 placeholder-slate-400" placeholder="Contoh: Bengkulu">
                    </div>
                    ...
                    <div class="col-span-1 md:col-span-2">
                        ...
                        <textarea name="alamat_lengkap" rows="3" required placeholder="Contoh: Jl. Merpati No. 15, Gang Ceria"
                            class="w-full rounded-md border-2 border-slate-300 bg-white px-3 py-2 text-sm focus:border-blue-500 focus:ring-blue-500">{{ old('alamat_lengkap') }}</textarea>
        ...
        <div class="flex justify-end gap-3 pt-6 border-t border-slate-100">
            <a href="{{ route('admin.kependudukan.keluarga.index') }}" class="px-4 py-2 text-slate-600 bg-slate-100 hover:bg-slate-200 rounded-lg font-medium text-sm">Batal</a>
            <button type="submit" class="px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 font-medium text-sm">Simpan Data KK</button>
        </div>
    </form>
</div>
@endsection
