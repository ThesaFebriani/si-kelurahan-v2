...
<div class="max-w-4xl mx-auto space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="bg-white rounded-lg shadow border border-gray-200">
            ...
            <div class="p-4 space-y-3">
                @php $data = $permohonan->data_pemohon; @endphp
                ...
                <div class="flex justify-between">
                    ...
                    <span class="font-mono">{{ $data['nik'] ?? '-' }}</span>
                </div>
                ...
                <div class="flex justify-between">
                    ...
                    <span class="font-medium">
                        {{ $data['tempat_lahir'] ?? '-' }},
                        {{ isset($data['tanggal_lahir']) ? \Carbon\Carbon::parse($data['tanggal_lahir'])->format('d/m/Y') : '-' }}
                    </span>
                </div>
                ...
                <div class="flex justify-between">
                    ...
                    <span class="font-medium">{{ $data['agama'] ?? '-' }}</span>
                </div>

                <div class="flex justify-between">
                    <span class="text-gray-600">Status Perkawinan:</span>
                    <span class="font-medium">{{ $data['status_perkawinan'] ?? '-' }}</span>
                </div>

                <div class="flex justify-between">
                    <span class="text-gray-600">Pekerjaan:</span>
                    <span class="font-medium">{{ $data['pekerjaan'] ?? '-' }}</span>
                </div>
            </div>
        </div>
    ...
    <div class="bg-white rounded-lg shadow border border-gray-200">
        ...
        <div class="p-4 space-y-4">
            ...
            'jenis_kelamin','agama','status_perkawinan','pekerjaan','tujuan'
            ]))
            @continue
            @endif
