        ...
        <div class="bg-white rounded-lg shadow p-4 border border-gray-200">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <h3 class="text-xl font-bold text-gray-800 mt-1">{{ $stats['approved'] ?? 0 }}</h3>
                </div>
        ...
        <div class="bg-white rounded-lg shadow p-4 border border-gray-200">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <h3 class="text-xl font-bold text-gray-800 mt-1">{{ $stats['rejected'] ?? 0 }}</h3>
                </div>
