        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
            <div>
                <div class="flex items-center space-x-3 mb-2">
                    <span class="px-2.5 py-1 bg-cyan-50 text-cyan-700 border border-cyan-100 rounded-md text-[10px] font-bold uppercase tracking-wide">
            ...
            <div class="flex items-center gap-4">
                 <div class="text-right hidden md:block">
                    <span class="block text-[10px] text-slate-400 uppercase font-bold tracking-wider mb-1">Status Saat Ini</span>
                     <div class="inline-flex items-center px-3 py-1 rounded-full text-xs font-bold border 
                        @if(str_contains($permohonan->status, 'menunggu')) bg-yellow-50 text-yellow-700 border-yellow-200
                ...
                <a href="{{ route('kasi.permohonan.verify', $permohonan->id) }}" 
                   class="px-6 py-2.5 bg-cyan-600 hover:bg-cyan-700 text-white rounded-lg font-bold shadow-lg shadow-cyan-600/20 transition-all transform hover:-translate-y-0.5 flex items-center">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="px-6 py-4 border-b border-slate-100 bg-slate-50/50 flex justify-between items-center">
                    <h3 class="font-bold text-slate-800 flex items-center text-sm">
                        <i class="fas fa-user-check text-cyan-500 mr-2.5"></i> Data Pemohon
                    </h3>
                ...
                <div class="p-6">
                    ...
                    <div class="mt-6 pt-6 border-t border-slate-100">
                        ...
                        <div class="bg-cyan-50/50 border border-cyan-100 rounded-lg p-4 text-slate-700 font-medium text-sm leading-relaxed shadow-sm shadow-cyan-50">
                            {{ $dataPemohon['tujuan'] }}
                        </div>
                    </div>
                    @endif
                     ...
                     <div class="p-6">
                         <div class="flex items-center p-3 border border-blue-100 bg-blue-50/30 rounded-xl">
                             ...
                             <div class="flex-1 min-w-0">
                                 <p class="text-sm font-bold text-slate-800">Surat Pengantar RT {{ $permohonan->user->rt->nomor_rt ?? '...' }}</p>
                             ...
                             <a href="{{ route('documents.show', ['filename' => basename($permohonan->file_surat_pengantar_rt)]) }}" target="_blank"
                                class="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm rounded-lg transition-colors flex items-center shadow-sm font-bold">
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
                 ...
                 <a href="{{ route('kasi.permohonan.index') }}" class="flex items-center justify-center w-full p-3 bg-white border border-slate-200 text-slate-600 rounded-xl hover:bg-slate-50 hover:text-slate-800 transition-colors shadow-sm font-medium">
